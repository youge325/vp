...
| [03. Rust 桌面外壳架构](03-rust-shell-architecture.md) | Tauri Command、TaskSupervisor、任务状态机、持久化、资源解析 |
...
| [07. 任务生命周期](07-task-lifecycle.md) | 启动租约、取消/暂停流程、Watchdog、终态仲裁 |
...
- **优化性能**：查阅 04 后端架构（stage-worker 流水线）和 07 任务生命周期（Watchdog 配置）
