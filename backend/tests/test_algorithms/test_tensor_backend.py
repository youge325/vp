...
from app.algorithms.tensor_backend import (
    PyTorchBackend,
    PaddleBackend,
    get_tensor_backend,
)
...
class TestGetTensorBackend:
    """测试 get_tensor_backend 工厂函数。"""
    ...
    def test_get_unknown_raises(self):
        with pytest.raises(ValueError, match="未知 Tensor 后端"):
            get_tensor_backend("nonexistent")
