...
PixelShuffle 上采样、lastconv 输出 4*5=20 通道、支持 ensemble。

v4.5 相比 v4.4 的变化：conv→ResConv，ConvTranspose2d→PixelShuffle，上采样不再 scale*2。

参考 vs-rife 的 IFNet_HDv3_v4_5.py 实现。
"""
...
class IFBlock(nn.Module):
    ...
    ResConv + PixelShuffle 上采样，lastconv 输出 4*5=20 通道，输出 (flow, mask) 2 元组。
    """
