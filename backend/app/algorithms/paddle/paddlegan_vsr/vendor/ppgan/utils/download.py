...
from app.algorithms.paddle.paddlegan_vsr.weights import fixed_weight_root

PPGAN_HOME = str(fixed_weight_root() / "_auxiliary")
...
def _uncompress_file_zip(filepath):
    ...
    if _is_a_single_file(file_list):
        ...
        rootpath = os.path.splitext(file_list[0])[0].strip(os.sep).split(os.sep)[-1]
        uncompressed_path = os.path.join(file_dir, rootpath)
